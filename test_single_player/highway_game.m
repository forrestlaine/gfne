...
if make_video
    writerObj = VideoWriter('polite_highway','MPEG-4');
...
for t = 1:T+1
    if linear_dyn
        if plot_polite
            ...
            ext_bp = viscircles([Xp(5,t),Xp(6,t)],car_rad,'Color','r','LineStyle',':');
            ...
            ext_d = viscircles([X(13,t),X(14,t)],car_rad,'Color','g');
        end
...
function val = running_cost_a_polite(xu)
    ...
    yc = xu(10);
    yd = xu(14);
    val = 10*ua'*ua + running_cost_c(xu);
end
