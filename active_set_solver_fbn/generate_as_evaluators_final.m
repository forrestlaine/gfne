function evaluators = generate_as_evaluators_final(f,... % dynamics function
    ...
    for t = 1:T
        ...
        states_controls = [x{t+1}];
        pstates_controls = [x{t}];
        ...
        for i = 1:N
            ...
            pstates_controls = [pstates_controls; u{t,i}];
        end
        ...
        % Dynamics
        pred{t} = f(pstates_controls);
        jac_pred{t} = jacobian(pred{t},pstates_controls);
