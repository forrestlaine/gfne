...
[xval,ws] = fb_game_solver_active_set(@f, h, g, l, n, m, N, T, x0, rollout_x0, params, @plot_solution);
solution_set{1} = xval;
...
[xval,ws] = fb_game_solver_active_set(@f, h, g, l, n, m, N, T, x0, rollout_x0, params, @plot_solution,ws,xval);
solution_set{2} = xval;
...
plot_solution_set({solution_set{4},solution_set{3},solution_set{1}});
...
function val = running_cost_a1(xu)
    ...
    xa1 = xu(1:4);
    ua1 = xu(17:18);
    val = ua1'*R*ua1 + speed_pen*speed_cost(xa1,gv_a1) + left_lane_cost(xa1);
end
...
function val = running_cost_b1(xu)
    ...
    xb1 = xu(5:8);
    ub1 = xu(19:20);
    val = ub1'*R*ub1 + speed_pen*speed_cost(xb1,gv_b1) + 0.01*left_lane_cost(xb1);
end
...
function val = running_cost_b2(xu)
    ...
    xb2 = xu(9:12);
    ub2 = xu(21:22);
    val = ub2'*R*ub2 + speed_pen*speed_cost(xb2,gv_b2) + 0.01*left_lane_cost(xb2);
end
